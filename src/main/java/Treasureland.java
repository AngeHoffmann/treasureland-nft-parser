...
public class Treasureland {
    ...
    public void getInfo() throws IOException, ParseException {
        ...
        for (int i = 1; i <= pageCount; i++) {
            ...
            if (i == 1) {
                System.out.println("All Alpaca's NFT = " + filteredResponse.get("dataCount").get(0));
            }
            System.out.printf("parsing: [%d/%d] page, [%d/%d] nfts\n", i, pageCount, pageSize*i, pageSize*pageCount);
